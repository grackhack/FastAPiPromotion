...
```bash
ssh botuser@195.133.49.121 "cd ~/FastAPiPromotion && git pull && source .venv/bin/activate && pip install -e . && pkill -f 'uvicorn main:app' && cd wb_promotion_app && nohup python -m uvicorn main:app --host 0.0.0.0 --port 8001 > ../app.log 2>&1 &"
```
